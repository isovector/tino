...
if exists("b:did_ftplugin_htex")
  finish
endif

" Don't load another plugin for this buffer
let b:did_ftplugin_htex = 1
...
if filereadable('Makefile')
  ...
  exec "setlocal makeprg=make\\ -f\\ ~/.dotfiles/vim/hlatex.mk\\ " . substitute(bufname("%"),"htex$","pdf", "")
endif

noremap       <leader>sh :set syntax=haskell<CR>:setlocal nospell<CR>
noremap       <leader>st :set syntax=tex<CR>:setlocal spell<CR>
vmap      <leader>eh S{i\evalhaskell<ESC>llxh%hx$
